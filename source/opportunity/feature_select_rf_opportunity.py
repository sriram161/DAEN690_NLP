...
neg_sel_df = metric_data_prep(x_neg_df, neg_s, n=54, flag='chi2')
unc_sel_df = metric_data_prep(x_unc_df, unc_s, n=10, flag='chi2')
bag_sel_df = metric_data_prep(x_bag_df, bag_s, n=200, flag='chi2')
wnt_sel_df = metric_data_prep(x_wnt_df, wnt_s, n=14, flag='chi2')
thl_sel_df = metric_data_prep(x_thl_df, thl_s, n=6, flag='chi2')
tag_sel_df = metric_data_prep(x_tag_df, tag_s, n=35, flag='chi2')
...
model_eval(RandomForestClassifier, df_chi_eng, y_relavence_lit_df, title='chi2', n_estimators=100)

# for 327
chi_sel_df = metric_data_prep(df_chi_eng, chi_s, n=327, flag='chi2')
model_eval(RandomForestClassifier, chi_sel_df, y_relavence_lit_df, title='chi2', n_estimators=100)


# MIC 
# for chi2 data after feateure engineering
lit_mic_sel_df = metric_data_prep(x_lit_df, lit_s, n=4, flag='mic')
pos_mic_sel_df = metric_data_prep(x_pos_df, pos_s, n=23, flag='mic')
neg_mic_sel_df = metric_data_prep(x_neg_df, neg_s, n=18, flag='mic')
unc_mic_sel_df = metric_data_prep(x_unc_df, unc_s, n=2, flag='mic')
bag_mic_sel_df = metric_data_prep(x_bag_df, bag_s, n=200, flag='mic')
wnt_mic_sel_df = metric_data_prep(x_wnt_df, wnt_s, n=44, flag='mic')
thl_mic_sel_df = metric_data_prep(x_thl_df, thl_s, n=2, flag='mic')
tag_mic_sel_df = metric_data_prep(x_tag_df, tag_s, n=171, flag='mic')
...
model_eval(RandomForestClassifier, df_mic_eng, y_relavence_lit_df,
           title='mic', n_estimators=100)

mic_sel_df = metric_data_prep(df_mic_eng, mic_s, n=413, flag='mic')
