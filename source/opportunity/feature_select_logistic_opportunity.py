...
bag_df = pd.read_csv(data_path+"bag_of_words.csv")
...
model_exec(LogisticRegression, lit_x_train, lit_x_test, lit_y_train, lit_y_test, 2, 2, 'lit',
...
model_exec(LogisticRegression, neg_x_train, neg_x_test, neg_y_train, neg_y_test, 3, 5, 'neg',
           neg_s, 'chi2', C=0.1, solver='lbfgs', multi_class='ovr')
model_exec(LogisticRegression, unc_x_train, unc_x_test, unc_y_train, unc_y_test, 2, 2, 'unc',
           unc_s, 'chi2', C=0.1, solver='lbfgs', multi_class='ovr')
model_exec(LogisticRegression, bag_x_train, bag_x_test, bag_y_train, bag_y_test, 200, 533, 'bag',
           bag_s, 'chi2', C=0.1, solver='lbfgs', multi_class='ovr')
model_exec(LogisticRegression, wnt_x_train, wnt_x_test, wnt_y_train, wnt_y_test, 5, 9, 'wnt',
           wnt_s, 'chi2', C=0.1, solver='lbfgs', multi_class='ovr')
model_exec(LogisticRegression, thl_x_train, thl_x_test, thl_y_train, thl_y_test, 1, 3, 'thl',
           thl_s, 'chi2', C=0.1, solver='lbfgs', multi_class='ovr')
model_exec(LogisticRegression, tag_x_train, tag_x_test, tag_y_train, tag_y_test, 30, 34, 'tag',
...
lit_sel_df = metric_data_prep(x_lit_df, lit_s, n=4, flag='chi2')
pos_sel_df = metric_data_prep(x_pos_df, pos_s, n=23, flag='chi2')
neg_sel_df = metric_data_prep(x_neg_df, neg_s, n=53, flag='chi2')
unc_sel_df = metric_data_prep(x_unc_df, unc_s, n=10, flag='chi2')
bag_sel_df = metric_data_prep(x_bag_df, bag_s, n=1799, flag='chi2')
wnt_sel_df = metric_data_prep(x_wnt_df, wnt_s, n=77, flag='chi2')
thl_sel_df = metric_data_prep(x_thl_df, thl_s, n=4, flag='chi2')
tag_sel_df = metric_data_prep(x_tag_df, tag_s, n=132, flag='chi2')
...
# update after chi specific data set
model_exec(LogisticRegression, chi_x_train, chi_x_test, chi_y_train, chi_y_test, 100, 222, 'chi',
           chi_s,'chi2',C=0.1 , solver='lbfgs', multi_class='ovr')

# For 988 attribute of chi2.
model_eval(LogisticRegression, df_chi_eng, y_relavence_lit_df, title='chi2', C=0.1, solver='lbfgs', multi_class='ovr')

chi_sel_df = metric_data_prep(df_chi_eng, chi_s, n=988, flag='chi2')
x = model_eval(LogisticRegression, chi_sel_df, y_relavence_lit_df, title='chi2', C=0.1, solver='lbfgs', multi_class='ovr')
x.to_csv("log_opp_chi.csv")
# MIC 
# for chi2 data after feateure engineering
lit_mic_sel_df = metric_data_prep(x_lit_df, lit_s, n=8, flag='mic')
pos_mic_sel_df = metric_data_prep(x_pos_df, pos_s, n=30, flag='mic')
neg_mic_sel_df = metric_data_prep(x_neg_df, neg_s, n=53, flag='mic')
unc_mic_sel_df = metric_data_prep(x_unc_df, unc_s, n=10, flag='mic')
bag_mic_sel_df = metric_data_prep(x_bag_df, bag_s, n=2332, flag='mic')
wnt_mic_sel_df = metric_data_prep(x_wnt_df, wnt_s, n=88, flag='mic')
thl_mic_sel_df = metric_data_prep(x_thl_df, thl_s, n=4, flag='mic')
tag_mic_sel_df = metric_data_prep(x_tag_df, tag_s, n=336, flag='mic')
...
model_exec(LogisticRegression, mic_x_train, mic_x_test, mic_y_train, mic_y_test, 
           100, 306, 'mic', mic_s, 'mic', C=0.1, solver='lbfgs', multi_class='ovr')

model_eval(LogisticRegression, df_mic_eng, y_relavence_lit_df,
           title='mic', C=0.1, solver='lbfgs', multi_class='ovr')

mic_sel_df = metric_data_prep(df_mic_eng, mic_s, n=712, flag='mic') #best result
