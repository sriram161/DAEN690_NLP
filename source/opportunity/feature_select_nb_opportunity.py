...
lit_sel_df = metric_data_prep(x_lit_df, lit_s, n=2, flag='chi2')
tag_sel_df = metric_data_prep(x_tag_df, tag_s, n=31, flag='chi2')
thl_sel_df = metric_data_prep(x_thl_df, thl_s, n=17, flag='chi2')
wnt_sel_df = metric_data_prep(x_wnt_df, wnt_s, n=10, flag='chi2')
pos_sel_df = metric_data_prep(x_pos_df, pos_s, n=200, flag='chi2')
neg_sel_df = metric_data_prep(x_neg_df, neg_s, n=28, flag='chi2')
unc_sel_df = metric_data_prep(x_unc_df, unc_s, n=26, flag='chi2')
bag_sel_df = metric_data_prep(x_bag_df, bag_s, n=240, flag='chi2')
...
# For 215 attribute of chi2.
model_eval(GaussianNB, df_chi_eng, y_relavence_lit_df, title='chi2')
# for 215
chi_sel_df = metric_data_prep(df_chi_eng, chi_s, n=215, flag='chi2')
...
neg_mic_sel_df = metric_data_prep(x_neg_df, neg_s, n=10, flag='mic')
unc_mic_sel_df = metric_data_prep(x_unc_df, unc_s, n=4, flag='mic')
bag_mic_sel_df = metric_data_prep(x_bag_df, bag_s, n=200, flag='mic')
wnt_mic_sel_df = metric_data_prep(x_wnt_df, wnt_s, n=83, flag='mic')
thl_mic_sel_df = metric_data_prep(x_thl_df, thl_s, n=26, flag='mic')
tag_mic_sel_df = metric_data_prep(x_tag_df, tag_s, n=310, flag='mic')
...
mic_sel_df = metric_data_prep(df_mic_eng, mic_s, n=83, flag='mic')
x = model_eval(GaussianNB, mic_sel_df, y_relavence_lit_df,
           title='mic')
x.to_csv('nb_opp_mic.csv')
