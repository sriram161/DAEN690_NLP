...
pos_sel_df = metric_data_prep(x_pos_df, pos_s, n=15, flag='chi2')
neg_sel_df = metric_data_prep(x_neg_df, neg_s, n=71, flag='chi2')
unc_sel_df = metric_data_prep(x_unc_df, unc_s, n=7, flag='chi2')
bag_sel_df = metric_data_prep(x_bag_df, bag_s, n=100, flag='chi2')
wnt_sel_df = metric_data_prep(x_wnt_df, wnt_s, n=50, flag='chi2')
thl_sel_df = metric_data_prep(x_thl_df, thl_s, n=3, flag='chi2')
...
chi_s.to_csv("logistics_sustain_feat.csv")

model_exec(LogisticRegression, chi_x_train, chi_x_test, chi_y_train, chi_y_test, 10, 25, 'chi',
           chi_s,'chi2',C=0.1 , solver='lbfgs', multi_class='ovr')

# for 35
chi_sel_df = metric_data_prep(df_chi_eng, chi_s, n=35, flag='chi2')
x = model_eval(LogisticRegression, chi_sel_df, y_relavence_lit_df, title='chi2', C=0.1, solver='lbfgs', multi_class='ovr')
x.to_csv('logistics_sustain_chi.csv')
# MIC 
# for chi2 data after feateure engineering
...
unc_mic_sel_df = metric_data_prep(x_unc_df, unc_s, n=16, flag='mic')
bag_mic_sel_df = metric_data_prep(x_bag_df, bag_s, n=100, flag='mic')
wnt_mic_sel_df = metric_data_prep(x_wnt_df, wnt_s, n=40, flag='mic')
thl_mic_sel_df = metric_data_prep(x_thl_df, thl_s, n=9, flag='mic')
...
model_exec(LogisticRegression, mic_x_train, mic_x_test, mic_y_train, mic_y_test, 10, 25, 'mic',
           mic_s, 'mic', C=0.1, solver='lbfgs', multi_class='ovr')

# for 85
mic_sel_df = metric_data_prep(df_mic_eng, mic_s, n=85, flag='mic') #best result
x = model_eval(LogisticRegression, mic_sel_df, y_relavence_lit_df,
           title='mic', C=0.1, solver='lbfgs', multi_class='ovr')
x.to_csv('logistics_sustain_mic.csv')