...
model_exec(GaussianNB, lit_x_train, lit_x_test, lit_y_train, lit_y_test, 2, 1, 'lit',
           lit_s, 'chi2')
model_exec(GaussianNB, pos_x_train, pos_x_test, pos_y_train, pos_y_test, 3, 3, 'pos',
           pos_s, 'chi2')
model_exec(GaussianNB, neg_x_train, neg_x_test, neg_y_train, neg_y_test, 5, 11, 'neg',
           neg_s, 'chi2')
model_exec(GaussianNB, unc_x_train, unc_x_test, unc_y_train, unc_y_test, 2, 1, 'unc',
           unc_s, 'chi2')
model_exec(GaussianNB, bag_x_train, bag_x_test, bag_y_train, bag_y_test, 100, 500, 'bag',
           bag_s, 'chi2')
model_exec(GaussianNB, wnt_x_train, wnt_x_test, wnt_y_train, wnt_y_test, 10, 10, 'wnt',
           wnt_s, 'chi2')
model_exec(GaussianNB, thl_x_train, thl_x_test, thl_y_train, thl_y_test, 3, 3, 'thl',
           thl_s, 'chi2')
model_exec(GaussianNB, tag_x_train, tag_x_test, tag_y_train, tag_y_test, 10, 111, 'tag',
           tag_s, 'chi2')
...
tag_sel_df = metric_data_prep(x_tag_df, tag_s, n=454, flag='chi2')
thl_sel_df = metric_data_prep(x_thl_df, thl_s, n=18, flag='chi2')
wnt_sel_df = metric_data_prep(x_wnt_df, wnt_s, n=20, flag='chi2')
pos_sel_df = metric_data_prep(x_pos_df, pos_s, n=30, flag='chi2')
neg_sel_df = metric_data_prep(x_neg_df, neg_s, n=16, flag='chi2')
unc_sel_df = metric_data_prep(x_unc_df, unc_s, n=15, flag='chi2')
bag_sel_df = metric_data_prep(x_bag_df, bag_s, n=100, flag='chi2')
...
# For 3690 attribute of chi2.
model_eval(GaussianNB, df_chi_eng, y_relavence_lit_df, title='chi2')
# for 154
chi_sel_df = metric_data_prep(df_chi_eng, chi_s, n=154, flag='chi2')
model_eval(GaussianNB, chi_sel_df, y_relavence_lit_df, title='chi2')

# for 82
chi_sel_df = metric_data_prep(df_chi_eng, chi_s, n=82, flag='chi2')
x = model_eval(GaussianNB, chi_sel_df, y_relavence_lit_df, title='chi2')

x.to_csv('nb_growth_chi_84.csv')

# MIC 
# for chi2 data after feateure engineering
lit_mic_sel_df = metric_data_prep(x_lit_df, lit_s, n=8, flag='mic')
tag_mic_sel_df = metric_data_prep(x_tag_df, tag_s, n=10, flag='mic')
thl_mic_sel_df = metric_data_prep(x_thl_df, thl_s, n=24, flag='mic')
wnt_mic_sel_df = metric_data_prep(x_wnt_df, wnt_s, n=90, flag='mic')
pos_mic_sel_df = metric_data_prep(x_pos_df, pos_s, n=27, flag='mic')
neg_mic_sel_df = metric_data_prep(x_neg_df, neg_s, n=93, flag='mic')
unc_mic_sel_df = metric_data_prep(x_unc_df, unc_s, n=8, flag='mic')
bag_mic_sel_df = metric_data_prep(x_bag_df, bag_s, n=4100, flag='mic')
...
mic_sel_df = metric_data_prep(df_mic_eng, mic_s, n=1519, flag='mic')
model_eval(GaussianNB, mic_sel_df, y_relavence_lit_df,
           title='chi2')

mic_sel_df = metric_data_prep(df_mic_eng, mic_s, n=1992, flag='mic')
model_eval(GaussianNB, mic_sel_df, y_relavence_lit_df,
           title='chi2')

mic_sel_df = metric_data_prep(df_mic_eng, mic_s, n=4357, flag='mic')
model_eval(GaussianNB, mic_sel_df, y_relavence_lit_df,
           title='chi2')
