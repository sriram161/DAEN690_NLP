...
# for 1748
chi_sel_df = metric_data_prep(df_chi_eng, chi_s, n=1748, flag='chi2')
model_eval(RandomForestClassifier, chi_sel_df, y_relavence_lit_df, title='chi2', n_estimators=100)

# for 2909
chi_sel_df = metric_data_prep(df_chi_eng, chi_s, n=2909, flag='chi2')
model_eval(RandomForestClassifier, chi_sel_df, y_relavence_lit_df, title='chi2', n_estimators=100)

# for 3683
chi_sel_df = metric_data_prep(df_chi_eng, chi_s, n=3683, flag='chi2')
model_eval(RandomForestClassifier, chi_sel_df, y_relavence_lit_df, title='chi2', n_estimators=100)
...
wnt_mic_sel_df = metric_data_prep(x_wnt_df, wnt_s, n=70, flag='mic')
pos_mic_sel_df = metric_data_prep(x_pos_df, pos_s, n=24, flag='mic')
neg_mic_sel_df = metric_data_prep(x_neg_df, neg_s, n=82, flag='mic')
...
mic_sel_df = metric_data_prep(df_mic_eng, mic_s, n=2324, flag='mic')
model_eval(RandomForestClassifier, mic_sel_df, y_relavence_lit_df,
           title='chi2', n_estimators=100)

mic_sel_df = metric_data_prep(df_mic_eng, mic_s, n=2678, flag='mic')
model_eval(RandomForestClassifier, mic_sel_df, y_relavence_lit_df,
           title='chi2', n_estimators=100)

mic_sel_df = metric_data_prep(df_mic_eng, mic_s, n=3032, flag='mic')
model_eval(RandomForestClassifier, mic_sel_df, y_relavence_lit_df,
           title='chi2', n_estimators=100)
